...
As seen on figure \ref{subfig:pt-spectrum}, $P[\pT|\mathrm{target}]$ decreases monotonically with $\pT$, limiting the contribution from high-$\pT$ particles to the loss function, and thus directing the attention away.
